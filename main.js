...
// Lösung -1-
/*let arr = [];
arr = Object.keys(emojis);
// console.log(arr);
for(let i = 0; i<arr.length; i++){
    document.write(`<img src= "${emojis[arr[i]]}" alt= "arrow_right" > ${arr[i]} <br>`);
}*/


// Lösung -2-
const uncompiled = document.getElementById("emojiList-template").innerHTML;
const compiled = Handlebars.compile(uncompiled);
const compiledWithObject = compiled(emojis);
// append to html
document.getElementById("output").innerHTML = compiledWithObject;
console.log(compiledWithObject);